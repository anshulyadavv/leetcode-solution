...
const COMPANY_DATA_DIR = path.resolve(__dirname, "../../companies_questions");
const SCRAPED_DATA_DIR = path.resolve(__dirname, "../../scraped_topics");
...
const EXTERNAL_COMPANY_DATA_DIR = path.resolve(__dirname, "../../external_data");
